    ...
    <>
      ...
      <main id={styles.ebook} className='container'>
        ...
        <section className={styles.paragraph}>
          ...
          <p className={styles.text}>
            Si te gustaría compartir tu historia o sumar tu experiencia para una próxima edición, escribime a <a target='_blank' href='mailto:hola@devias.ar'>hola@devias.ar</a> o por <a target='_blank' href="https://www.linkedin.com/company/devias-ar/mycompany/?viewAsMember=true">LinkedIn</a>.
          </p>
